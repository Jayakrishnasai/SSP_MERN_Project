...
const programs = [
  {
    ...
    duration: '12 Weeks',
    tag: 'Trending',
    description: 'Master AWS, Azure, Docker, Kubernetes and CI/CD pipelines with real-world infrastructure.',
  },
  {
    id: 'ai-data-science',
    ...
    duration: '16 Weeks',
    tag: 'High Growth',
    description: 'Comprehensive training in machine learning, Python, and predictive analytics for data-driven decisions.',
  },
  {
    ...
    duration: '8 Weeks',
    tag: 'Foundation',
    description: 'Advanced Python with Django, high-performance data structures, and API development.',
  },
  {
    ...
    duration: '6 Weeks',
    tag: 'Core',
    description: 'A robust foundation in system administration, Bash scripting, and enterprise-grade security.',
  },
  {
    ...
    duration: '8 Weeks',
    tag: 'Advanced',
    description: 'SQL, NoSQL, and high-availability systems for distributed large-scale data storage.',
  },
  {
    id: 'web-engineering',
    ...
    duration: '12 Weeks',
    tag: 'Popular',
    description: 'Modern full-stack development with React, Node.js, and TypeScript for the modern web.',
  },
];
