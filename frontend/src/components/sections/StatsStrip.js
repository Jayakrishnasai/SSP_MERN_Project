...
const stats = [
  {
    ...
    description: 'Expertly trained and placed in top global firms.',
  },
  {
    id: 'industry-experts',
    value: '15+',
    label: 'Industry Experts',
    description: 'Directly mentoring your personalized career path.',
  },
  {
    id: 'success-rate',
    value: '95%',
    label: 'Success Rate',
    description: 'Exceptional placement and certification rate.',
  },
  {
    id: 'tech-programs',
    value: '25+',
    label: 'Tech Programs',
    description: 'Cutting-edge courses designed for modern tech.',
  },
];
