...
const testimonials = [
  { id: 'sai-teja', name: 'E. SaiTeja', company: 'GlobalTech Solutions', image: '/images/SaiTeja.jpg', quote: 'The DevOps training at Perseverance was a game-changer. I secured a 100% hike within 3 months of graduation.' },
  { id: 'jaswanth', name: 'Jaswanth', company: 'Innovation Hub', image: '/images/jaswanth.jpg', quote: 'Mentor-led approach is what sets them apart. Real projects, real feedback, and tangible career growth.' },
  { id: 'jaya-krishna-sai', name: 'Jaya Krishna Sai', company: 'Soft Systems', image: '/images/jaya_krishna.jpg', quote: 'Highly recommend the Cloud Computing course for anyone looking to enter the high-growth IT field.' },
];
            ...
            <div key={testimonial.id} className="w-full md:w-1/3 px-4 mb-8">
              <div className="h-full !p-8 border-none bg-white dark:bg-navy-800 shadow-2xl flex flex-col justify-between hover:-translate-y-2 transition-all duration-700 rounded-3xl relative group">
                ...
                <div className="mb-8 relative z-10">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-6 text-base font-medium leading-relaxed italic opacity-90 group-hover:opacity-100 transition-opacity">"{testimonial.quote}"</p>
                </div>
                ...
                <div className="flex items-center space-x-4 border-t border-gray-100 dark:border-navy-900/50 pt-6 relative z-10">
                  ...
                  <div>
                    <h5 className="font-black text-lg text-navy-900 dark:text-white tracking-tighter leading-none mb-1">{testimonial.name}</h5>
                    <p className="text-blue-600 dark:text-accent text-[8px] font-black uppercase tracking-[0.2em]">{testimonial.company}</p>
                  </div>
                </div>
              </div>
            </div>
