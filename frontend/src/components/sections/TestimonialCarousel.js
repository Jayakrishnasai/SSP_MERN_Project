...
const testimonials = [
  {
    id: 'saiteja-globaltech',
    name: 'E. SaiTeja',
    company: 'GlobalTech Solutions',
    image: '/images/SaiTeja.jpg',
    quote: 'The DevOps training at Perseverance was a game-changer. I secured a 100% hike within 3 months of graduation.',
  },
  {
    id: 'jaswanth-innovation-hub',
    name: 'Jaswanth',
    company: 'Innovation Hub',
    image: '/images/jaswanth.jpg',
    quote: 'Mentor-led approach is what sets them apart. Real projects, real feedback, and tangible career growth.',
  },
  {
    id: 'jaya-soft-systems',
    name: 'Jaya Krishna Sai',
    company: 'Soft Systems',
    image: '/images/jaya_krishna.jpg',
    quote: 'Highly recommend the Cloud Computing course for anyone looking to enter the high-growth IT field.',
  },
];
              ...
              <div className="h-full !p-8 border-none bg-white dark:bg-navy-800 shadow-2xl flex flex-col justify-between hover:-translate-y-2 transition-all duration-700 rounded-3xl relative group">
                ...
                <div className="mb-8 relative z-10">
                  <div className="flex text-accent mb-6 space-x-1">
                    {ratingStars.map((star) => <span key={star} className="text-lg drop-shadow-md">★</span>)}
                  </div>
